...
Source0  : https://download.gnome.org/sources/simple-scan/3.36/simple-scan-3.36.1.tar.xz
...
%prep
%setup -q -n simple-scan-3.36.1
cd %{_builddir}/simple-scan-3.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585777150
...
cp %{_builddir}/simple-scan-3.36.1/COPYING %{buildroot}/usr/share/package-licenses/simple-scan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
