...
Source0  : https://download.gnome.org/sources/simple-scan/40/simple-scan-40.1.tar.xz
...
%prep
%setup -q -n simple-scan-40.1
cd %{_builddir}/simple-scan-40.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622762602
...
cp %{_builddir}/simple-scan-40.1/COPYING %{buildroot}/usr/share/package-licenses/simple-scan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
