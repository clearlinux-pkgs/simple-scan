...
Source0  : https://download.gnome.org/sources/simple-scan/3.38/simple-scan-3.38.2.tar.xz
...
%prep
%setup -q -n simple-scan-3.38.2
cd %{_builddir}/simple-scan-3.38.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607490138
...
cp %{_builddir}/simple-scan-3.38.2/COPYING %{buildroot}/usr/share/package-licenses/simple-scan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
