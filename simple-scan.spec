...
Version  : 40.6
Release  : 35
URL      : https://download.gnome.org/sources/simple-scan/40/simple-scan-40.6.tar.xz
Source0  : https://download.gnome.org/sources/simple-scan/40/simple-scan-40.6.tar.xz
...
%prep
%setup -q -n simple-scan-40.6
cd %{_builddir}/simple-scan-40.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635961191
...
cp %{_builddir}/simple-scan-40.6/COPYING %{buildroot}/usr/share/package-licenses/simple-scan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
