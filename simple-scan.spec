...
Version  : 3.31.1
Release  : 11
URL      : https://download.gnome.org/sources/simple-scan/3.31/simple-scan-3.31.1.tar.xz
Source0  : https://download.gnome.org/sources/simple-scan/3.31/simple-scan-3.31.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1539815507
