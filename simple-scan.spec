...
Source0  : https://download.gnome.org/sources/simple-scan/40/simple-scan-40.0.tar.xz
...
%prep
%setup -q -n simple-scan-40.0
cd %{_builddir}/simple-scan-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619121014
...
cp %{_builddir}/simple-scan-40.0/COPYING %{buildroot}/usr/share/package-licenses/simple-scan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
