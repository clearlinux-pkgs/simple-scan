...
Source0  : https://download.gnome.org/sources/simple-scan/3.32/simple-scan-3.32.2.1.tar.xz
...
%prep
%setup -q -n simple-scan-3.32.2.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1557164455
export AR=gcc-ar
