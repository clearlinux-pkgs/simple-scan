...
Version  : 3.29.4
Release  : 5
URL      : https://download.gnome.org/sources/simple-scan/3.29/simple-scan-3.29.4.tar.xz
Source0  : https://download.gnome.org/sources/simple-scan/3.29/simple-scan-3.29.4.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-3.0
Requires: simple-scan-bin
Requires: simple-scan-data
Requires: simple-scan-license
Requires: simple-scan-locales
Requires: simple-scan-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1531720396
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain   builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/doc/simple-scan
cp COPYING %{buildroot}/usr/share/doc/simple-scan/COPYING
