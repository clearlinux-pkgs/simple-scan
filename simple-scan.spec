...
%prep
%setup -q -n simple-scan-3.36.2
cd %{_builddir}/simple-scan-3.36.2
...
cp %{_builddir}/simple-scan-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/simple-scan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
