...
Source0  : https://download.gnome.org/sources/simple-scan/3.34/simple-scan-3.34.2.tar.xz
...
%prep
%setup -q -n simple-scan-3.34.2
cd %{_builddir}/simple-scan-3.34.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574453732
...
cp %{_builddir}/simple-scan-3.34.2/COPYING %{buildroot}/usr/share/package-licenses/simple-scan/8624bcdae55baeef00cd11d5dfcfa60f68710a02
