...
Source0  : https://download.gnome.org/sources/simple-scan/44/simple-scan-44.0.tar.xz
...
%prep
%setup -q -n simple-scan-44.0
cd %{_builddir}/simple-scan-44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680042318
